...
export const en: Translation = {
	...
	// Drama Data Page
	[Key.drama]: "Drama Resources",
	[Key.dramaSubtitle]: "Curated quality drama resources with multi-platform cloud storage downloads",
	[Key.dramaLastUpdated]: "Last updated",
	[Key.dramaEmpty]: "No drama resources",
	[Key.dramaEmptyReason]: "No drama resources have been added to this category yet",
	[Key.dramaRating]: "Rating",
	[Key.dramaYear]: "Year",
	[Key.dramaEpisodes]: "Episodes",
	[Key.dramaStatus]: "Status",
	[Key.dramaGetResource]: "Get Resource",
	[Key.dramaDriveType]: "Cloud Storage",
	[Key.dramaTags]: "Tags",
	[Key.dramaCategoryChinese]: "Chinese Drama",
	[Key.dramaCategoryKorean]: "Korean Drama",
	[Key.dramaCategoryWestern]: "Western Drama",
	[Key.dramaCategoryJapanese]: "Japanese Drama",
	[Key.dramaCategoryThai]: "Thai Drama",
	[Key.dramaCategoryTaiwanese]: "Taiwanese Drama",
	[Key.dramaTotalCount]: "Total",
};
