...
export const zh_CN: Translation = {
	...
	// 影视数据页面
	[Key.drama]: "影视资源",
	[Key.dramaSubtitle]: "精选优质影视资源，支持多平台网盘下载",
	[Key.dramaLastUpdated]: "数据更新于",
	[Key.dramaEmpty]: "暂无影视资源",
	[Key.dramaEmptyReason]: "当前分类下还没有添加任何影视资源",
	[Key.dramaRating]: "评分",
	[Key.dramaYear]: "年份",
	[Key.dramaEpisodes]: "集数",
	[Key.dramaStatus]: "状态",
	[Key.dramaGetResource]: "获取资源",
	[Key.dramaDriveType]: "网盘类型",
	[Key.dramaTags]: "标签",
	[Key.dramaCategoryChinese]: "国产剧",
	[Key.dramaCategoryKorean]: "韩剧",
	[Key.dramaCategoryWestern]: "欧美剧",
	[Key.dramaCategoryJapanese]: "日剧",
	[Key.dramaCategoryThai]: "泰剧",
	[Key.dramaCategoryTaiwanese]: "台剧",
	[Key.dramaTotalCount]: "共",
};
